...
import dev.tauri.jsgcore.utils.MathHelper;
...
public class StargateRendererStatic {
	...
	private static final List<Float> offsetList = new ArrayList<Float>();
	// private long horizonStateChange = 0;
	private static final List<Float> sin = new ArrayList<Float>();
	private static final List<Float> cos = new ArrayList<Float>();

	private static final List<Float> quadRadius = new ArrayList<Float>();
